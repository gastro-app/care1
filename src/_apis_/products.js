...
const PRODUCT_NAME = [
  'Full FRESHK box',
  'Full FRESHK Organic box',
  'Mini FRESHK box',
  'Mini FRESHK Organic box',
  'Super FRESHK box',
  'Super FRESHK Organic box',
  'Full Seafood FRESHK box',
  'Mini Seafood FRESHK box'
];
...
const products = [...Array(6)].map((_, index) => ({
  ...
  images: [...Array(6)].map((_, index) => mockData.image.product(index)),
